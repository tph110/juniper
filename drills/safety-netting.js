    ...
    exercises: [
        {
            ...
            videoPrompt: `Medium close-up of a worried woman in her early thirties holding a flushed toddler on her lap in a UK GP consulting room, natural window light, static camera, shallow depth of field. She looks tired and anxious, glancing down at the child then back up. She says, in a British accent: "So I just keep an eye on him then?" She then falls silent and holds her gaze on the doctor, waiting for an answer. Documentary realism, unretouched, no music, no captions, no on-screen text.`,
        },
        {
            id: 'daniel-headache',
            patient: 'Daniel, 34',
            ...
            videoPrompt: `Medium close-up of a 34-year-old man in a UK GP consulting room, natural window light, static camera, shallow depth of field. He looks slightly sceptical and rubs his temple, making brief eye contact. He says, in a British accent: "It's probably just stress then, isn't it?" He then falls silent and holds his gaze on the doctor, waiting for an answer. Documentary realism, unretouched, no music, no captions, no on-screen text.`,
        },
        {
            id: 'beverley-chest',
            patient: 'Beverley, 61',
